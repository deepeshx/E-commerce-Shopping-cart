...
$session = session_id();
//to make sure all data is passec along to next step,we check if $_POST ['same_info '] is set.
...
<ol>
	<li>Enter billing and shipping info</li>
	<li><strong>Verify accuracy and order info and send order</strong></li>
...
<table style="width: 75%;">
	...
	<img src="images/<?php echo $product_code; ?>.jpg" alt="<?php echo $name; ?>" />
	</td> 
	<td> <?php echo $name; ?></td>
	<td> <?php echo $qty; ?></td>
